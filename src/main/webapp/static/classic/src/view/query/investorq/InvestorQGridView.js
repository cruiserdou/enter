 ...
 */
Ext.define('app.view.query.investorq.InvestorQGridView', {
    extend: 'Ext.grid.Panel',
    xtype: 'investorqgridview',
    columnLines: true,
    requires: [
        'app.view.query.investorq.InvestorQController',
        'app.store.corpall.CorpInvAllStore',
    ...
    columns: [
        ...
        {text: '企业维护状态', width: 120, dataIndex: 'mai_query', hidden: true},
        ...
        {text: '投资领域', width: 120, dataIndex: 'inv_domain'},
        {text: '证监会行业分类1', width: 120, dataIndex: 'inv_csrc_type1'},
        {text: '证监会行业分类2', width: 120, dataIndex: 'inv_csrc_type2'},
        {text: '证监会行业分类3', width: 120, dataIndex: 'inv_csrc_type3'},
        {text: '证监会行业分类4', width: 120, dataIndex: 'inv_csrc_type4'},
        {text: '行业一级分类', width: 120, dataIndex: 'inv_indclass1'},
        {text: '行业二级分类', width: 120, dataIndex: 'inv_indclass2'},
        {text: '行业三级分类', width: 120, dataIndex: 'inv_indclass3'},
        {text: '行业四级分类', width: 120, dataIndex: 'inv_indclass4'},
        {text: '联系人', width: 120, dataIndex: 'inv_contact'},
        {text: '职务', width: 120, dataIndex: 'inv_psotion'},
        {text: '证件类型', width: 120, dataIndex: 'inv_doctype'},
        {text: '证件号码', width: 120, dataIndex: 'inv_docnum'},
        {text: '手机号码', width: 120, dataIndex: 'inv_phone'},
        {text: '传真', width: 120, dataIndex: 'inv_fax'},
        {text: 'E-mail', width: 120, dataIndex: 'inv_email'},
        {text: 'QQ',width: 120, dataIndex: 'inv_qq'},
        {text: '个人微信号', width: 120, dataIndex: 'inv_webchat'},
        {text: '固定电话', width: 120, dataIndex: 'inv_tel'},
        {text: '备注', flex: 1, dataIndex: 'inv_remark'},
