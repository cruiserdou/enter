...
var corp_apply_con_tpl = new Ext.XTemplate(
    ...
    '<th>地域</th>',
    '<td>',
    '<select onchange="areaCh();" style="width: 70px" class="select" name="province"  id="province">',
    ...
    '<th>行业一级分类</th>',
    '<td>    ' +
    '<select style="width: 230px"   class="select" name="indclass1" id="indclass1">',
    '<option>{indclass1}</option>',
    ' </select>',
    '</td>',
    '<th>行业二级分类</th>',
    '<td>',
    '<select style="width: 230px" class="select" name="indclass2" id="indclass2">',
    ...
    '<th>行业三级分类</th>',
    '<td>',
    '<select style="width: 230px" class="select" name="indclass3" id="indclass3">',
    ...
    '<th>证监会行业一级分类</th>',
    '<td>    ' +
    '<select style="width: 230px" class="select" name="csrc_type1" id="csrc_type1">',
    ...
    '<th>行业一级分类</th>',
    '<td>',
    '<select style="width: 230px" class="select" name="inv_csrc_type1" id="inv_csrc_type1">',
    '<option>{inv_csrc_type1}</option>',
    ' </select>',
    '</td>',
    '<th>行业二级分类</th>',
    '<td>',
    '<select style="width: 230px" class="select" name="inv_csrc_type2" id="inv_csrc_type2">',
    ...
    '<th>行业三级分类</th>',
    '<td>',
    '<select style="width: 230px" class="select" name="inv_csrc_type3" id="inv_csrc_type3">',
    ...
    '<th>证监会行业一级分类</th>',
    '<td>    ' +
    '<select style="width: 230px" class="select" name="inv_indclass1" id="inv_indclass1">',
